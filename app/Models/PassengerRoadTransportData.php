...
/**
 * Class PassengerRoadTransportData
 * @package App\Models
 * @version December 1, 2022, 12:58 pm UTC
 *
 * @property string $year
 * @property integer $number_of_passengers_carried
 ...
 */
class PassengerRoadTransportData extends Model
{
    // use SoftDeletes;

    use HasFactory;

    public $table = 'passenger_road_transport_data';
     ...
     */
    public static $rules = [
        'year' => 'required|integer|unique:passenger_road_transport_data,year',
