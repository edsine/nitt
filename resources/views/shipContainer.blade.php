    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $ship->id }}</td>
                <td>{{ $ship->year }}</td>
                <td>{{ $ship->number_of_passenger_carried }}</td>
                <td>{{ $ship->number_vehicle_in_fleet }}</td>
                <td>{{ $ship->revenue_from_operation }}</td>
                
                <td>
                    <button class="btn btn-warning btn-sm edit-record" data-id="{{ $ship->id }}" data-toggle="modal" data-target="#editModal" data-record="{{ $ship }}">Edit</button>
                    <button class="btn btn-danger btn-sm delete-record" data-id="{{ $ship->id }}" data-toggle="modal" data-target="#deleteModal" data-record="{{ $ship }}">Delete</button>
                    <button class="btn btn-info btn-sm view-chart" data-id="{{ $ship->id }}" data-toggle="modal" data-target="#chartModal" data-record="{{ $ship }}">View Chart</button> 
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="addForm" action="{{ route('shipContainerTraffic.store') }}" method="POST">
            @csrf
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="editForm" action="{{ route('shipContainerTraffic.update', '') }}" method="POST">
            @csrf
            @method('PUT')
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="deleteForm" action="{{ route('shipContainerTraffic.destroy', '') }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-content">
                <div class="modal-header">
