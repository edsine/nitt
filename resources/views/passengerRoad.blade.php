    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $passenger->number_of_passenger_carried }}</td>
                <td>{{ $passenger->number_vehicle_in_fleet }}</td>
                <td>{{ $passenger->revenue_from_operation }}</td>
                <td>{{ $passenger->number_of_employees }}</td>
                <td>{{ $passenger->annual_cost_of_vehicle_maintenance }}</td>
                <td>{{ $passenger->number_of_accidents }}</td>
                <td>
