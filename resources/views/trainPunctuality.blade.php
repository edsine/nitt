    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $train->id }}</td>
                <td>{{ $train->year }}</td>
                <td>{{ $train->number_of_passenger_carried }}</td>
                <td>{{ $train->number_vehicle_in_fleet }}</td>
                <td>{{ $train->revenue_from_operation }}</td>
                
                <td>
                    <button class="btn btn-warning btn-sm edit-record" data-id="{{ $train->id }}" data-toggle="modal" data-target="#editModal" data-record="{{ $train }}">Edit</button>
                    <button class="btn btn-danger btn-sm delete-record" data-id="{{ $train->id }}" data-toggle="modal" data-target="#deleteModal" data-record="{{ $train }}">Delete</button>
                    <button class="btn btn-info btn-sm view-chart" data-id="{{ $train->id }}" data-toggle="modal" data-target="#chartModal" data-record="{{ $train }}">View Chart</button> 
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="addForm" action="{{ route('trainPunctuality.store') }}" method="POST">
            @csrf
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="editForm" action="{{ route('trainPunctuality.update', '') }}" method="POST">
            @csrf
            @method('PUT')
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="deleteForm" action="{{ route('trainPunctuality.destroy', '') }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-content">
                <div class="modal-header">
