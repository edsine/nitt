...
import { editMaritimeTransport } from "../../store/actions";

const EditMaritimeTransport = (props) => {
  const {
    isOpen,
    setIsOpen,
    oldData,
  ...
  const handleValidSubmit = (event, values) => {
    onEditMaritimeTransport(values, oldData.id);
  };
...
EditMaritimeTransport.propTypes = {
  onEditMaritimeTransport: PropTypes.func,
  error: PropTypes.any,
...
const mapDispatchToProps = (dispatch) => ({
  onEditMaritimeTransport: (values, id) =>
    dispatch(editMaritimeTransport(values, id)),
});
