...
import { editGrossDomesticProduct } from "../../store/actions";
import YearOptions from "../yearOptions";

const EditGrossDomesticProduct = (props) => {
  const {
    isOpen,
    setIsOpen,
    oldData,
    onEditGrossDomesticProduct,
    error,
    success,
  } = props;
  ...
  const handleValidSubmit = (event, values) => {
    onEditGrossDomesticProduct(values, oldData.id);
  };
      ...
      >
        ...
        <div className="modal-body">
          ...
          <Row>
            ...
            <Col md="4">
              <div className="mb-3">
                <Label htmlFor="post_and_courier_services">
...
EditGrossDomesticProduct.propTypes = {
  onEditGrossDomesticProduct: PropTypes.func,
  error: PropTypes.any,
...
const mapDispatchToProps = (dispatch) => ({
  onEditGrossDomesticProduct: (values, id) =>
    dispatch(editGrossDomesticProduct(values, id)),
});
