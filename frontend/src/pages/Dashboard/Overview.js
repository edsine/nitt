                        ...
                        <div>
                            <div className="pb-3 border-bottom">
                                <Row className="align-items-center">
                                    <Col xs={8}>
                                        <p className="mb-2">Registered Airlines (Domestic)</p>
                            ...
                            <div className="py-3 border-bottom">
                                <Row className="align-items-center">
                                    <Col xs={8}>
                                        <p className="mb-2">Deregistered Airlines (International)</p>
                            ...
                            <div className="pt-3">
                                <Row className="align-items-center">
                                    <Col xs={8}>
                                        <p className="mb-2">Registered Airlines (International)</p>
                                        <h4 className="mb-0">1,653</h4>
                                    </Col>
                                    <Col xs={4}>
                                        <div className="text-end">
                                            <div>
